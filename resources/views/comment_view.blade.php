    ...
    @foreach ($comment as $comment)
          ...
          @endforeach
            ...
            <div class="box-footer">
              ...
              {{ csrf_field() }}
                <input name="id_notify" type="hidden" value="<?php echo $data->id;?>">
                ...
                <div class="img-push">
                    ...
                    <div class="col-md-8">
                        <input type="text" name="rating" class="form-control input-sm" placeholder="Press enter to post comment">
                    </div>
                    </div>
                    <div class="row">
                    <div class="col-md-10">
